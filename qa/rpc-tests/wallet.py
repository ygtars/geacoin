...
#   c) node1 mines 32 blocks, so now node 0 has 60001gea, node 1 has 4250gea, node2 has none.
#   d) node0 sends 601 gea to node2, in two transactions (301 gea, then 300 gea).
