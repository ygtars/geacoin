...
RESOURCES += src/qt/gea.qrc src/qt/gea_locale.qrc

TRANSLATIONS += src/qt/locale/gea_bg.ts \
                src/qt/locale/gea_de.ts \
                src/qt/locale/gea_en.ts \
                src/qt/locale/gea_es.ts \
                src/qt/locale/gea_fi.ts \
                src/qt/locale/gea_fr.ts \
                src/qt/locale/gea_it.ts \
                src/qt/locale/gea_ja.ts \
                src/qt/locale/gea_pl.ts \
                src/qt/locale/gea_pt.ts \
                src/qt/locale/gea_ru.ts \
                src/qt/locale/gea_sk.ts \
                src/qt/locale/gea_sv.ts \
                src/qt/locale/gea_vi.ts \
                src/qt/locale/gea_zh_CN.ts \
                src/qt/locale/gea_zh_TW.ts
