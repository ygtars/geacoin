...
This issue tracker is only for technical issues related to GEA Core.
General GEA questions and/or support requests and are best directed to the [GEA Discord](https://discord.gea.org).
...
### What version of GEA Core are you using?
