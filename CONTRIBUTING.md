Contributing to GEA Core
============================

The GEA Core project operates an open contributor model where anyone is
...
The following applies to code changes to the GEA Core project, and is not to be
confused with overall GEA Network Protocol consensus changes.

Whether a pull request is merged into GEA Core rests with the project merge
...
Patches that change GEA consensus rules are considerably more involved than
...
Where a patch set proposes to change the GEA consensus, it must have been
...
The project leader is the release manager for each GEA Core release.
