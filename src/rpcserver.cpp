...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* GEA features */
        {"gea", "masternode", &masternode, true, true, false},
        {"gea", "listmasternodes", &listmasternodes, true, true, false},
        {"gea", "getmasternodecount", &getmasternodecount, true, true, false},
        {"gea", "masternodeconnect", &masternodeconnect, true, true, false},
        {"gea", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"gea", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"gea", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"gea", "masternodecurrent", &masternodecurrent, true, true, false},
        {"gea", "masternodedebug", &masternodedebug, true, true, false},
        {"gea", "startmasternode", &startmasternode, true, true, false},
        {"gea", "createmasternodekey", &createmasternodekey, true, true, false},
        {"gea", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"gea", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"gea", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"gea", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"gea", "getmasternodescores", &getmasternodescores, true, true, false},
        {"gea", "mnbudget", &mnbudget, true, true, false},
        {"gea", "preparebudget", &preparebudget, true, true, false},
        {"gea", "submitbudget", &submitbudget, true, true, false},
        {"gea", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"gea", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"gea", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"gea", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"gea", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"gea", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"gea", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"gea", "checkbudgets", &checkbudgets, true, true, false},
        {"gea", "mnsync", &mnsync, true, true, false},
        {"gea", "spork", &spork, true, true, false},
        {"gea", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzgeaseed", &getzgeaseed, false, false, true},
        {"zerocoin", "setzgeaseed", &setzgeaseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzgea", &searchdzgea, false, false, true},
        {"zerocoin", "dzgeastate", &dzgeastate, false, false, true}
...
{
    return "> gea-cli " + methodname + " " + args + "\n";
}
