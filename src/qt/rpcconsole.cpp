                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzGEAPathCustom = GetArg("-zgeabackuppath", "");
    ...
    if(!strzGEAPathCustom.empty()) {
        ui->wallet_customzgeabackuppath->setText(QString::fromStdString(strzGEAPathCustom));
        ui->wallet_customzgeabackuppath_label->setVisible(true);
        ui->wallet_customzgeabackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzGEAPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the GEA RPC console.") + "<br>" +
