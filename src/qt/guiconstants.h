...
/* GEA GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "GEA-Core"
#define QAPP_ORG_DOMAIN "geacoin.io"
#define QAPP_APP_NAME_DEFAULT "GEA-Qt"
#define QAPP_APP_NAME_TESTNET "GEA-Qt-testnet"
