                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("GEA-Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a GEA address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and gea: URIs)"));
...
//    privacyAction->setStatusTip(tr("Privacy Actions for zGEA"));
...
//    tabGroup->addAction(privacyAction);
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About GEA Core"), this);
    aboutAction->setStatusTip(tr("Show information about GEA Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for GEA"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your GEA addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified GEA addresses"));
    ...
    openAction->setStatusTip(tr("Open a GEA: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the GEA Core help message to get a list with possible GEA command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("GEA Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to GEA network", "", count));
}
...
{
    QString strTitle = tr("GEA-Core"); // default title
