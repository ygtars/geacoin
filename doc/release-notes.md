PIVX Core version *3.1.1* is now available from:  <https://github.com/gea-actual/gea-coin/releases>
...
Please report bugs using the issue tracker at github: <https://github.com/gea-actual/gea-coin/issues>
