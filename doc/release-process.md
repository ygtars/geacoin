...
* Update translations see [translation_process.md](https://github.com/gea-actual/gea-coin/blob/master/doc/translation_process.md#synchronising-translations).
...
### Build and sign GEA Core for Linux, Windows, and OS X:
    ...
    ./bin/gbuild --memory 3000 --commit gea=v${VERSION} ../gea/contrib/gitian-descriptors/gitian-osx.yml
...
- Detached signatures will then be committed to the [gea-detached-sigs](https://github.com/gea-actual/gea-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
space *do not upload these to the geacoin.io server*.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/gea-actual/gea-coin/releases/new) with a link to the archived release notes.
