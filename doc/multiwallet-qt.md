...
In order to support loading of multiple wallets in gea-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is gea.cpp.
...
Changes to gea.cpp
----------------------
gea.cpp is the entry point into gea-qt, and as such, will require some minor modifications to provide hooks for
